...
# Embedded file name: C:\Users\Administrator\Desktop\Japan.py
...
try:
    ...
    try:
        ...
        if sys.platform == 'linux':
            ...
            os.system('sudo pip3 install fake-useragent')
        ...
        def run(self):
            ...
            while True:
                try:
                    ...
                    exit(Fore.RED + '[-]Dibatalkan Oleh Pengguna !!!')
                except Exception:
    ...
    class MainLoop:
        ...
        def home(self):
            ...
            print("       |-----------------------------------------------------------|")
            time.sleep(0.01)
            print("       |               DDOS BYPASS CLOUDFLARE                      |")
            print("       ##=========================================================##")
            time.sleep(1)
            print("       # Author   : </>./Riztrexx</>                               #")
            print("       # Blog     : https://blog-meta-cyber.web.app                #")
            print("       # WhatsApp : +62-878-1110-2801                              #")
            time.sleep(0.20)
            print("       ##=========================================================##")
            print(" ")
            if os.name in ('nt', 'dos', 'ce'):
                os.system('title       ........::::: Tools By ./Riztrexx DDOS Bypass Cloudflare :::::........')
            try:
                url = input('[*] Target mu Lurr [ex : https://domain.com] : ')
                num_threads = int(550)
                choice = 'high anonymous http/https/sock4/sock5'
                mode = input('[+] Methods HttpFlood[Y]/ CloudFlare[ENTER]: ')
